...
public class NetflowV5ToAvroCombinedRunner extends Configured implements Tool
{
    ...
    public static class Mapper extends AvroMapper< Flow, Pair< Long, CombinedData > >
    {
                              ...
                              Metrics metrics, Long srcAddr, Long dstAddr ) throws IOException
        {
            ...
            AdjacencyList adjacencyList = new AdjacencyList( srcAddr, new LinkedList<>(){{
                add(dstAddr);
            }} );
    ...
    public int run( String[] args ) throws Exception
    {
        ...
        AvroMultipleOutputs.addNamedOutput( conf,
            "flow", AvroOutputFormat.class, Flow.getClassSchema() );
        AvroMultipleOutputs.addNamedOutput( conf,
            "metrics", AvroOutputFormat.class, Metrics.getClassSchema() );
        AvroMultipleOutputs.addNamedOutput( conf,
            "adjacency", AvroOutputFormat.class, AdjacencyList.getClassSchema() );
