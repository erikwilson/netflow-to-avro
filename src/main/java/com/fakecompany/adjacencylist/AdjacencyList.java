 ...
 */
package com.fakecompany.adjacencylist;
...
public class AdjacencyList extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3970421969051420985L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AdjacencyList\",\"namespace\":\"com.fakecompany.adjacencylist\",\"fields\":[{\"name\":\"addr\",\"type\":\"long\"},{\"name\":\"neighbors\",\"type\":{\"type\":\"array\",\"items\":\"long\"}}]}");
   ...
   */
  public AdjacencyList(java.lang.Long addr, java.util.List<java.lang.Long> neighbors) {
    this.addr = addr;
   ...
   */
  public static com.fakecompany.adjacencylist.AdjacencyList.Builder newBuilder() {
    return new com.fakecompany.adjacencylist.AdjacencyList.Builder();
  }
   ...
   * @return A new AdjacencyList RecordBuilder
   */
  public static com.fakecompany.adjacencylist.AdjacencyList.Builder newBuilder(com.fakecompany.adjacencylist.AdjacencyList.Builder other) {
    return new com.fakecompany.adjacencylist.AdjacencyList.Builder(other);
  }
   ...
   * @return A new AdjacencyList RecordBuilder
   */
  public static com.fakecompany.adjacencylist.AdjacencyList.Builder newBuilder(com.fakecompany.adjacencylist.AdjacencyList other) {
    return new com.fakecompany.adjacencylist.AdjacencyList.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AdjacencyList>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.fakecompany.adjacencylist.AdjacencyList.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.fakecompany.adjacencylist.AdjacencyList other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.addr)) {
        this.addr = data().deepCopy(fields()[0].schema(), other.addr);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fakecompany.adjacencylist.AdjacencyList.Builder setAddr(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fakecompany.adjacencylist.AdjacencyList.Builder clearAddr() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fakecompany.adjacencylist.AdjacencyList.Builder setNeighbors(java.util.List<java.lang.Long> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fakecompany.adjacencylist.AdjacencyList.Builder clearNeighbors() {
      neighbors = null;
