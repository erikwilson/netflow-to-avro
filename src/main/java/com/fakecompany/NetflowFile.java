...
/**
 * <code>NetflowFile</code>s are flat files consisting of binary key/value
 * pairs.
 *
 * <p><code>NetflowFile</code> provides {@link NetflowFile.Writer},
 * {@link NetflowFile.Reader} and {@link Sorter} classes for writing,
 * reading and sorting respectively.</p>
 *
 * There are three <code>NetflowFile</code> <code>Writer</code>s based on the
 ...
 * provided by the <code>NetflowFile</code> to chose the preferred format.</p>
 *
 * <p>The {@link NetflowFile.Reader} acts as the bridge and can read any of the
 * above <code>NetflowFile</code> formats.</p>
 *
 * <h4 id="Formats">NetflowFile Formats</h4>
 *
 * <p>Essentially there are 3 different formats for <code>NetflowFile</code>s
 * depending on the <code>CompressionType</code> specified. All of them share a
 * <a href="#Header">common header</a> described below.
 *
 * <h5 id="Header">NetflowFile Header</h5>
 * <ul>
 *   <li>
 ...
 * </ul>
 *
 * <h5 id="#UncompressedFormat">Uncompressed NetflowFile Format</h5>
 * <ul>
 * <li>
 ...
 * </ul>
 *
 * <h5 id="#RecordCompressedFormat">Record-Compressed NetflowFile Format</h5>
 * <ul>
 * <li>
 * <a href="#Header">Header</a>
 * </li>
 ...
 * </ul>
 *
 * <h5 id="#BlockCompressedFormat">Block-Compressed NetflowFile Format</h5>
 * <ul>
 * <li>
 * <a href="#Header">Header</a>
 * </li>
...
public class NetflowFile {
    private static final Logger LOG = LoggerFactory.getLogger(NetflowFile.class);

    private NetflowFile() {}                         // no public ctor
    ...
    /**
     * Construct the preferred type of NetflowFile Writer.
     * @param fs The configured filesystem.
     * @param conf The configuration.
     * @param name The name of the file.
     * @param keyClass The 'key' type.
     * @param valClass The 'value' type.
     * @return Returns the handle to the constructed NetflowFile Writer.
     * @throws IOException
    ...
    /**
     * Construct the preferred type of 'raw' NetflowFile Writer.
     * @param conf The configuration.
    ...
    /** The interface to 'raw' values of NetflowFiles. */
    ...
    public static class Writer implements java.io.Closeable, Syncable {
        ...
        private static Option filesystem(FileSystem fs) {
            return new NetflowFile.Writer.FileSystemOption(fs);
        }
        ...
        Writer(Configuration conf,
            ...
            if (ownStream) {
                ...
                if (appendIfExistsOption != null && appendIfExistsOption.getValue()
                    ...
                    NetflowFile.Reader reader = new NetflowFile.Reader(conf,
                            NetflowFile.Reader.file(p), new Reader.OnlyHeaderOption());
                    try {
                        ...
                        metadataOption = (MetadataOption) NetflowFile.Writer
            ...
            if (codec != null &&
                ...
                throw new IllegalArgumentException("NetflowFile doesn't work with " +
         ...
         * @deprecated Use
         *   {@link NetflowFile#createWriter(Configuration, Writer.Option...)}
         *   instead.
         */
        @Deprecated
         ...
         * immediately after calling {@link NetflowFile.Reader#seek(long)} with a position
         * returned by this method, {@link NetflowFile.Reader#next(Writable)} may be called.  However
    ...
    public static class Reader implements java.io.Closeable {
         ...
         *                  reader {@link NetflowFile.Sorter.cloneFileAttributes},
        ...
        private void init(boolean tempReader) throws IOException {
            ...
            String exceptionMsg = this + " not a NetflowFile";
            ...
            if ((versionBlock[0] != VERSION[0]) ||
                ...
                throw new IOException(this + " not a NetflowFile");
            }
        ...
        /** @deprecated Call {@link #nextRaw(DataOutputBuffer,NetflowFile.ValueBytes)}. */
        @Deprecated
        synchronized int next(DataOutputBuffer buffer) throws IOException {
            ...
            if (blockCompressed) {
                throw new IOException("Unsupported call for block-compressed" +
                        " NetflowFiles - use NetflowFile.Reader.next(DataOutputStream, ValueBytes)");
            }
            try {
         ...
         * NetflowFile.Writer#getLength()} when writing this file.  To seek to an arbitrary
         * position, use {@link NetflowFile.Reader#sync(long)}.
         */
    ...
    public static class Sorter {
        ...
        } // NetflowFile.Sorter.SortPass

        /** The interface to iterate over raw keys/values of NetflowFiles. */
        ...
        } // NetflowFile.Sorter.SegmentDescriptor
        ...
        } //NetflowFile.Sorter.LinkedSegmentsDescriptor
        ...
        } //NetflowFile.Sorter.SegmentContainer
